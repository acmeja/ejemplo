...
//Establecer el array con los datos para el gráfico de Barra número 1
...
// Crear el gráfico. Estas dos llamadas son siempre requeridas.
$graph = new Graph(750,320,'auto');
$graph->SetScale("textlin");
$graph->SetY2Scale("lin",0,90);
$graph->SetY2OrderBack(false);

// Establecer los márgenres
...
// Establecer meses como leyendas en el eje X
...
// Establecer color y leyenda para cada plot
...
// Desplegar y visualziar el gráfico
$graph->Stroke();
?>